...
module.exports = {
    ...
    add:async function(req,res){
        ...
        if (cartItems.length == 0) {
         ...
         Cartitems.findOrCreate({userid:req.body.userid,productId:req.body.productId},{Name:req.body.Name,Price:req.body.price,Link:req.body.link,Quantity:req.body.Quantity,productId:req.body.productId,userid:req.body.userid}).exec((err,user,wasCreated)=>{
